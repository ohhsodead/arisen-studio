...
## Beta v3.3.4
- Updated DiscordRichPresence package to 1.6.1.70
- Updated FluentFTP package to 53.0.2
- Updated HtmlAgilityPack package to 1.12.4
- Updated WebView2 package to 1.0.3650.58
- Updated NLog package to 6.0.7
- Added support for PS4 connections (beta) (#131)
- Added fallback for languages with untranslated strings
- Fixed displaying local USB devices (#151)
- Fixed issues loading due to WebView module (Thanks @goldug)
- Removed unsupported newline sequence (#149)
