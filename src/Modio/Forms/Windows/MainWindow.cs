...
using Modio.Models.Release_Data;
...
namespace Modio.Forms.Windows
{
    public partial class MainWindow : ToolbarForm
    {
        ...
        /// </summary>
        public static ResourceManager ResourceLanguage { get; set; } = new ResourceManager("Modio.Languages.en_US", Assembly.GetExecutingAssembly());
        ...
        private async void MainWindow_Load(object sender, EventArgs e)
        {
            ...
            Text = $@"Modio - {UpdateExtensions.CurrentVersionName}";
        ...
        private void InitializeFinished()
        {
            ...
            SetStatus($"{ResourceLanguage.GetString("INITIALIZED")} Modio ({UpdateExtensions.CurrentVersionName}) - {ResourceLanguage.GetString("READY_TO_CONNECT")}");
...
#region Console File Explorer
        ...
        /// </summary>
        /// <param name=ResourceLanguage.GetString("LABEL_STATUS")> </param>
        /// <param name="ex"> </param>
...
#region Settings Page
        ...
        {
            { "English", "Modio.Languages.en_US" },
            { "Svenska", "Modio.Languages.sv_SE" },
            //{ "Español", "Modio.Languages.es_ES" },
            //{ "Português", "Modio.Languages.pt_PT" },
            //{ "Português (Brasil)", "Modio.Languages.pt_BR" }
        };
        ...
        private void ChangeLanguage(string languageName)
        {
            ...
            try
            {
                Thread.CurrentThread.CurrentUICulture = new CultureInfo(ResourceLanguage.BaseName.Replace("_", "-").Replace("Modio.Languages.", ""));
                ...
                TileItemToolsBackupFileManager.Text = ResourceLanguage.GetString("BACKUP_FILE_MANAGER");
                TileItemToolsGameUpdateFinder.Text = ResourceLanguage.GetString("GAME_UPDATE_FINDER");
                TileItemToolsPackageManager.Text = ResourceLanguage.GetString("PACKAGE_FILE_MANAGER");
...
#region Install, Uninstall, Download & Favorite Functions
        ...
        {
            LabelAboutTitle.Text = $@"Modio ({UpdateExtensions.CurrentVersionName})";
