namespace Modio.Constants
{
    public static class Urls
    {
        ...
        /// </summary>
        internal const string GitHubRepo = "https://github.com/ohhsodead/Modio/";

        /// <summary>
        /// Direct link to get the release information via GitHub API.
        /// </summary>
        internal const string GitHubReleases = "https://api.github.com/repos/ohhsodead/Modio/releases";
