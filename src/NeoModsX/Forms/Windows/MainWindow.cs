...
namespace NeoModsX.Forms.Windows
{
    public partial class MainWindow : ToolbarForm
    {
        ...
        /// </summary>
        public static ResourceManager ResourceLanguage { get; set; } = new ResourceManager("NeoModsX.Languages.en_US", Assembly.GetExecutingAssembly());
        ...
        private async void MainWindow_Load(object sender, EventArgs e)
        {
            ...
            Text = $@"NeoModsX - {UpdateExtensions.CurrentVersionName}";
        ...
        private void InitializeFinished()
        {
            ...
            SetStatus($"{ResourceLanguage.GetString("INITIALIZED")} NeoModsX ({UpdateExtensions.CurrentVersionName}) - {ResourceLanguage.GetString("READY_TO_CONNECT")}");
    ...
    #region Settings Page
        ...
        {
            { "English", "NeoModsX.Languages.en_US" },
            { "Svenska", "NeoModsX.Languages.sv_SE" },
            //{ "Español", "NeoModsX.Languages.es_ES" },
            //{ "Português", "NeoModsX.Languages.pt_PT" },
            //{ "Português (Brasil)", "NeoModsX.Languages.pt_BR" }
        };
        ...
        private void ChangeLanguage(string languageName)
        {
            ...
            try
            {
                Thread.CurrentThread.CurrentUICulture = new CultureInfo(ResourceLanguage.BaseName.Replace("_", "-").Replace("NeoModsX.Languages.", ""));
        ...
        {
            Process.Start("https://crowdin.com/project/NeoModsX");
        }
        ...
        public void SetPresence()
        {
            if (Settings.AlwaysShowPresence)
            {
                DiscordClient.SetPresence(new RichPresence()
                {
                    ...
                    Buttons = new DiscordRPC.Button[] { new DiscordRPC.Button() { Label = "Download NeoModsX", Url = "https://github.com/ohhsodead/NeoModsX" } },
                    Assets = new Assets()
                    {
                        LargeImageKey = "NeoModsX",
                        LargeImageText = "NeoModsX"
                    }
                });
    ...
    #region About Page
        ...
        {
            LabelAboutTitle.Text = $@"NeoModsX ({UpdateExtensions.CurrentVersionName})";
