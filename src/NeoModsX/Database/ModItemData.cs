...
namespace NeoModsX.Database
{
    ...
    public class ModItemData
    {
        ...
        public Platform GetPlatform()
        {
            ...
            {
                "PS3" => NeoModsX.Platform.PS3,
                "XBOX" => NeoModsX.Platform.XBOX360,
                _ => NeoModsX.Platform.PS3
            };
        }
        ...
        {
            return $@"{MainWindow.Settings.PathGameMods.GetFullPath(MainWindow.Settings.PathBaseDirectory)}\{Platform.Humanize()}\{Name.RemoveInvalidChars()}\{CreatedBy.RemoveInvalidChars()}\{downloadFiles.Name.RemoveInvalidChars()}{GetVersion(downloadFiles)}-{Id}\";
        }
        ...
        {
            return $@"{MainWindow.Settings.PathGameMods.GetFullPath(MainWindow.Settings.PathBaseDirectory)}\{Platform.Humanize()}\{Name.RemoveInvalidChars()}\{CreatedBy.RemoveInvalidChars()}\{downloadFiles.Name.RemoveInvalidChars()}{GetVersion(downloadFiles)}-{Id}.zip";
        }
