...
namespace ModioX.Extensions
{
    public static class WorkerExtensions
    {
        ...
        {
            bgw.DoWork += delegate(object obj, DoWorkEventArgs args) { args.Result = work.Invoke(); };
        ...
        {
            bgw.DoWork += delegate(object obj, DoWorkEventArgs args) { args.Result = work.DynamicInvoke(); };
        }
