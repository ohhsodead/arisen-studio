...
namespace ModioX.Extensions
{
    public class FtpConnection : IDisposable
    {
        ...
        public FtpDirectoryInfo[] GetDirectories(string path)
        {
            ...
            try
            {
                ...
                {
                    FtpDirectoryInfo item =
                        new FtpDirectoryInfo(this, new string(findFileData.fileName).TrimEnd(new char[1]))
                        {
    ...
    public class FtpDirectoryInfo : FileSystemInfo
    {
        ...
        {
            get { return this._attribues; }
            internal set { this._attribues = value; }
        }
        ...
        public DateTime? CreationTime
        {
            ...
            internal set { this._creationTime = value; }
        }
        ...
        public DateTime? LastAccessTime
        {
            ...
            internal set { this._lastAccessTime = value; }
        }
        ...
        public DateTime? LastWriteTime
        {
            ...
            internal set { this._lastWriteTime = value; }
        }
    ...
    public static class WININET
    {
        ...
        public static extern int InternetGetLastResponseInfo([In, Out] ref int dwError,
            [Out, MarshalAs(UnmanagedType.LPTStr)] StringBuilder buffer, [In, Out] ref int bufferLength);
        ...
        public static extern int InternetReadFileEx([In] IntPtr hFile,
            ...
            [In] int dwFlags, [In, Out] int dwContext);
    }
}