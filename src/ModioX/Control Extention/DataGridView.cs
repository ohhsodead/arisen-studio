...
namespace XDevkit
{
    public class XtraDataGridView : UserControl, ISupportInitialize
    {
        ...
        private static readonly DataGridViewCellStyle _cellStyleHeader = GetCellStyle(true, false, true);
        ...
        {
            var odd = isOdd ? Colors.GreyBackground : Colors.HeaderBackground;
            var focused = isFocused ? Colors.BlueSelection : Colors.GreySelection;
            return new DataGridViewCellStyle
            {
                BackColor = isHeader ? Colors.MediumBackground : odd,
                ForeColor = Colors.LightText,
                SelectionBackColor = isHeader ? Colors.MediumBackground : focused,
        ...
        public XtraDataGridView()
        {
            ...
            _base.BackgroundColor = Color.FromArgb(36,36,36);
        ...
        {
            _base.InvalidateCell(dataGridViewCell);
        }

        public void InvalidateCell(int columnIndex, int rowIndex)
        {
            _base.InvalidateCell(columnIndex, rowIndex);
        }

        public void InvalidateColumn(int columnIndex)
        {
            _base.InvalidateColumn(columnIndex);
        }

        public void InvalidateRow(int rowIndex)
        {
            _base.InvalidateRow(rowIndex);
        }

        public void NotifyCurrentCellDirty(bool dirty)
        {
            _base.NotifyCurrentCellDirty(dirty);
        }

        public bool RefreshEdit()
        {
            return _base.RefreshEdit();
        }
        ...
        {
            _base.UpdateCellErrorText(columnIndex, rowIndex);
        }

        public void UpdateCellValue(int columnIndex, int rowIndex)
        {
            _base.UpdateCellValue(columnIndex, rowIndex);
        }

        public void UpdateRowErrorText(int rowIndex)
        {
            _base.UpdateRowErrorText(rowIndex);
        }

        public void UpdateRowErrorText(int rowIndexStart, int rowIndexEnd)
        {
            _base.UpdateRowErrorText(rowIndexStart, rowIndexEnd);
        }

        public void UpdateRowHeightInfo(int rowIndex, bool updateToEnd)
        {
            _base.UpdateRowHeightInfo(rowIndex, updateToEnd);
        }
