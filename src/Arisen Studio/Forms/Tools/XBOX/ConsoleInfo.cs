...
namespace ArisenStudio.Forms.Tools.XBOX
{
    public partial class ConsoleInfo : XtraForm
    {
        ...
        {
            _ = Xbox.SetFanSpeed(0, TrackBarFanSpeed.Value);
        }
        ...
        private void ComboBoxXboxIcon_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            _ = XtraMessageBox.Show(this, "Changed Xbox Icon. Refresh Neighborhood to see the new name.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}